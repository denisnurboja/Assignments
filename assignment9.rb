# Write a Ruby script to take the string "Hello World" and split it on whitespace. Show two ways to do this.
p "Hello World".split(/ /)
p "Hello World".split

# Use the Peter Piper tongue twister and split it on 'pick'
p "Peter Piper picked a peck of pickled peppers. A peck of pickled peppers Peter Piper picked. If Peter Piper picked a peck of pickled peppers, Where's the peck of pickled peppers Peter Piper picked?".split("pick")
